  ...
  return (
    <div className="diagnostic-illustration">
      <svg viewBox="0 0 440 300" role="img" aria-label={title}>
        ...
        <rect x="0" y="0" width="440" height="300" rx="28" fill="#2a1854" />
        ...
        {[
          ...
          <g key={`${x}-${y}`}>
            <rect
              ...
              stroke={hi ? '#c4b5fd' : 'rgba(255,255,255,0.18)'}
              strokeWidth={hi ? 2 : 1}
            />
            <path
        ...
        <g stroke="#c4b5fd" strokeWidth="1.5" strokeDasharray="3 4" opacity="0.85">
          <line x1="140" y1="102" x2="172" y2="102" />
          <line x1="268" y1="212" x2="220" y2="102" />
        </g>

        <circle cx="92" cy="102" r="26" fill="none" stroke="#a855f7" strokeWidth="2" strokeDasharray="4 4">
          <animateTransform attributeName="transform" type="rotate" from="0 92 102" to="360 92 102" dur="9s" repeatCount="indefinite" />
        </circle>
        <line x1="110" y1="120" x2="122" y2="132" stroke="#a855f7" strokeWidth="4" strokeLinecap="round" />
  ...
  return (
    <div className="diagnostic-illustration">
      <svg viewBox="0 0 440 300" role="img" aria-label={title}>
        ...
        <g stroke="rgba(196,181,253,0.55)" strokeWidth="1.4">
          {nodes.map(({ x, y }) => (
        ...
        <circle cx="220" cy="150" r="30" fill="none" stroke="#a855f7" strokeWidth="2" strokeDasharray="5 5">
  ...
  return (
    <div className="diagnostic-illustration">
      <svg viewBox="0 0 440 300" role="img" aria-label={title}>
        ...
        <rect x="60" y="228" width="160" height="24" rx="8" fill="rgba(168,85,247,0.35)" stroke="#c4b5fd" />
        <text x="70" y="244" fill="#f3e8ff" fontSize="11" fontFamily="monospace">
        ...
        <g transform="translate(276,70)">
          {[0, 1, 2].map((i) => (
            <g key={i} transform={`translate(0, ${i * 62})`}>
              ...
              {i < 2 && (
                <path d="M6 0 L9 3 L15 -4" stroke="#1c1330" strokeWidth="1.6" fill="none" strokeLinecap="round" strokeLinejoin="round" />
              )}
